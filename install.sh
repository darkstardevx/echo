...
case "$os" in
  ...
  *) die "unsupported OS: $os (Echo supports Linux and macOS)" ;;
esac
...
install -m 755 "${tmp_dir}/wf-echo" "${INSTALL_DIR}/wf-echo"

echo ""
echo "Echo installed to ${INSTALL_DIR}/wf-echo"
case ":$PATH:" in
  *":$INSTALL_DIR:"*) ;;
  *) echo "Note: ${INSTALL_DIR} is not on your PATH. Add it, e.g.:" ;
     echo "  export PATH=\"${INSTALL_DIR}:\$PATH\"" ;;
esac
echo "Run 'wf-echo --help' to get started. Needs WraithFlow's capture_log configured -- see the README."
